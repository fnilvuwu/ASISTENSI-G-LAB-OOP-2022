...
public class TypeRacer {
    ...
    public void printRaceStanding() {
        ...
        // for (int i= 0; i<raceStanding.size(); i++) {
        //     int anu = raceStanding.get(i).getFinishTime();
        //     Double ini = new Double(anu);
        //     Double joy = Double.valueOf(ini)/1000;
        //     System.out.println(String.format("%d. %s = %.2f detik", i+1, raceStanding.get(i).getName(), joy));
        // }
    }
